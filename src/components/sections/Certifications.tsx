...
const cardHover =
  "transition-all duration-300 hover:-translate-y-1 hover:shadow-[0px_16px_34px_0px_#D98FAB40]";
...
export default function Certifications() {
  ...
  return (
    <section
      id="certifications"
      className="w-full bg-[var(--color-pink-100)] [background-image:linear-gradient(143.333deg,_#FFFFFFE6_21.054%,_#FFE7EE00_64.473%)] bg-no-repeat bg-[length:100%_100%] overflow-hidden relative scroll-mt-[110px]"
    >
      <div className="relative mx-auto max-w-[1440px] w-full box-border h-fit shrink-0 flex flex-col gap-[44px] p-[96px_64px] justify-start items-start">
        <div className="animate-float-slow box-border w-[320px] h-[320px] absolute left-[1180px] top-[-120px] bg-[#FFFFFF66] rounded-full [z-index:0]"></div>
        <motion.div
          initial={reduceMotion ? "show" : "hidden"}
          whileInView="show"
          viewport={{ once: true, amount: 0.2 }}
          variants={fadeUp}
          className="box-border w-[820px] h-fit shrink-0 flex flex-col gap-[14px] justify-start items-start relative [z-index:1]"
        >
        ...
        <motion.div
          ...
          variants={cardGrid}
          className="box-border w-full h-fit shrink-0 flex flex-row gap-[20px] justify-start items-start relative [z-index:2]"
        >
          <motion.div
            variants={cardItem}
            className={`box-border [flex:1_1_0] h-[270px] [box-shadow:0px_10px_28px_0px_#D98FAB26] flex flex-col gap-[14px] p-[26px] justify-start items-start bg-[var(--color-white)] rounded-[24px] ${cardHover}`}
          >
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
          variants={fadeUp}
          className="box-border w-full h-fit shrink-0 flex flex-row gap-[24px] p-[22px_32px] justify-between items-center bg-[#FFFFFFB3] rounded-[20px] relative [z-index:3]"
        >
