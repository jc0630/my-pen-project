...
export default function Contact() {
  ...
  return (
    <div className="box-border w-full h-fit shrink-0 flex flex-row gap-0 p-[96px_64px] justify-start items-start bg-[var(--color-white)]">
      <div className="box-border [flex:1_1_0] h-[659px] flex flex-row gap-0 justify-start items-start bg-[var(--color-pink-50)] rounded-[36px] overflow-hidden">
        ...
        >
          ...
          <div className="box-border w-full h-fit shrink-0 flex flex-row gap-[14px] justify-start items-start">
            <div className="box-border [flex:1_1_0] h-fit flex flex-col gap-[7px] justify-start items-start">
              ...
              <input
                ...
                name="contactName"
                placeholder="請輸入姓名"
                className="box-border w-full h-fit shrink-0 p-[14px_16px] bg-[var(--color-pink-50)] [outline:1px_solid_var(--color-pink-200)] [outline-offset:-0.5px] rounded-[14px] text-[14px]/[21px] font-main font-normal text-[var(--color-text-primary)] placeholder:text-[#B79AAA]"
              />
            </div>
            <div className="box-border [flex:1_1_0] h-fit flex flex-col gap-[7px] justify-start items-start">
              <label className="text-[13px]/[18px] box-border text-[var(--color-text-secondary)] font-main font-medium text-left [white-space:nowrap]">
              ...
              {SERVICE_TYPES.map((type) => {
                ...
                return (
                  <button
                    ...
                    className={
                      selected
                        ? "box-border w-fit shrink-0 h-fit flex flex-row gap-0 p-[10px_18px] justify-start items-start bg-[var(--color-pink-500)] [outline:1px_solid_var(--color-pink-500)] [outline-offset:-0.5px] rounded-[999px]"
                        : "box-border w-fit shrink-0 h-fit flex flex-row gap-0 p-[10px_18px] justify-start items-start bg-[var(--color-white)] [outline:1px_solid_var(--color-pink-200)] [outline-offset:-0.5px] rounded-[999px]"
                    }
                  >
                    <div
                      className={
                        selected
                          ? "text-[13.5px]/[19px] box-border text-[var(--color-white)] font-main font-medium text-left [white-space:nowrap]"
                          : "text-[13.5px]/[19px] box-border text-[var(--color-text-secondary)] font-main font-medium text-left [white-space:nowrap]"
                      }
                    >
                      {type}
                    </div>
          ...
          <div className="box-border w-full h-fit shrink-0 flex flex-col gap-[7px] justify-start items-start">
            ...
            <textarea
              ...
              className="box-border w-full h-[96px] shrink-0 p-[16px] bg-[var(--color-pink-50)] [outline:1px_solid_var(--color-pink-200)] [outline-offset:-0.5px] rounded-[14px] resize-none text-[14px]/[24px] font-main font-normal text-[var(--color-text-primary)] placeholder:text-[#B79AAA]"
            />
          </div>
          <button
            type="submit"
            className="box-border w-full h-fit shrink-0 [box-shadow:0px_8px_20px_0px_#FF7BA659] flex flex-row gap-[9px] p-[17px_0px] justify-center items-center bg-[var(--color-pink-500)] rounded-[999px]"
          >
